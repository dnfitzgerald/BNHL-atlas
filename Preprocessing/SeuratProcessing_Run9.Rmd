...
# Check doublets of B and T cells
FeaturePlot_custom2(sobj_tmp)
FeaturePlot_custom2(sobj_tmp, markers = c("CD79A", "CD3E"))
...
for(i in 1:length(sobjs)){
  saveRDS(object = sobjs[[i]], file = paste0("output/SeuratObjects_Proc/SeuratObjectProc_", 
                                             samples[i], ".rds"))
  }
