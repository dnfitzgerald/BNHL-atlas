...
FeatureScatter_custom1(sobj_tmp)
FeatureScatter_custom2(sobj_tmp)  
FeaturePlot_custom2(sobj_tmp, markers = "C1QC")

# UMAP Plot
DimPlot_custom1(sobj_tmp)

# Remove Cluster 5 (complement genes)
sobj_tmp <- subset(sobj_tmp, subset = seurat_clusters!=5) 
...
# Set processing parameters
nnFeature_RNA_low=1000
percent.mt_top=14
nFeature_RNA_top=6500 
dims.clustering=1:14
resolution.clustering = 0.4
dims.umap=1:14
...
# Remove Cluster 5 (complement genes)
sobj_tmp <- subset(sobj_tmp, subset = seurat_clusters!=4) 
